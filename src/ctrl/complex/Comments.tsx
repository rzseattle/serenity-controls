...
import i18n from "frontend/src/ctrl/lib/I18n";
            ...
            <div className="w-comments">
                ...
                {this.state.addMode && (
                    <div className="clearfix">
                        <a className="btn btn-primary pull-right" onClick={this.handleAddComment.bind(this)}>
                            {i18n.t("frontend:add")}
                        </a>
                        <a className="btn pull-right" onClick={this.handleCommentCancel.bind(this)}>
