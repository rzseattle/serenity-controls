...
export default class ErrorReporter extends React.Component<any, any> {
    ...
    public render() {
        ...
        const codeCss: any = {whiteSpace: "pre", backgroundColor: "#FDF3F4", color: "black", padding: 5, width: "100%", overflow: "auto"};
...
class StackFrame {
    ...
    public _originalFunctionName;
    public _originalFileName;
    public _originalLineNumber;
    public _originalColumnNumber;

    public _scriptCode;
    public _originalScriptCode;
