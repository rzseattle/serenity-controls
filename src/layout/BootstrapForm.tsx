...
const withBootstrapFormField = <P extends object>(Component: React.ComponentType<P>) =>
...
export const BText = withBootstrapFormField(Text);
export const BTextarea = withBootstrapFormField(Textarea);
export const BSelect = withBootstrapFormField(Select);
export const BSwitch = withBootstrapFormField(Switch);
export const BCheckboxGroup = withBootstrapFormField(CheckboxGroup);
export const BDate = withBootstrapFormField(Date);
export const BFile = withBootstrapFormField(File);
export const BWysiwig = withBootstrapFormField(Wysiwyg);
export const BConnectionsField = withBootstrapFormField(ConnectionsField);
export const BFileList = withBootstrapFormField(FileList);
export const BContainer = withBootstrapFormField((props) => <div>{props.children}</div>);

export { withBootstrapFormField };
