...
export class DebugTool extends React.Component<IDebugToolProps, any> {
    ...
    routeReloadHandler(): any {
        ...
        fetch(url.toString()).then((result) => {
            ...
            result.json().then((x) => {
                console.log(x);
                console.log(module.hot.status()); //1
            ...
            <div className={"w-debug-tool"} tabIndex={1} style={this.state.style}>
                ...
                {s.expanded && (
                    <div className="expanded">
                        ...
                        />
                        {extendedInfo && (
                            <div style={{ padding: 5, borderTop: "solid 1px grey" }}>
                                <div>
                                    <Copyable>
                                        {extendedInfo._debug.file}:{extendedInfo._debug.line}
                                    </Copyable>
                                </div>
                                <div>
                                    <Copyable>{extendedInfo._debug.template}</Copyable>
                                </div>
                            </div>
                        )}
                    </div>
